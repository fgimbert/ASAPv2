...
class AIMD(object):
    ...
    def __create_config(self):
        ...
        self.rundft_button = LoadedButton(description='Run DFT', value=None, disabled=False)

        self.workdir_text = widgets.Text(    
            placeholder='/home/f-gimbert/TESTAIMD',
            value = '/home/f-gimbert/TESTAIMD',
    ...
    def input_files(self):
        ...
        with open('input_aimd/pyRun_script.sh', 'r') as jobfile:
            ...
            with open('input_aimd/pyRun.sh', 'w', newline='\n') as filejob:
                filejob.write(filedata)

        with open('input_aimd/script.py', 'r') as jobfile:
            filedata = jobfile.read()
            ...
            # Write the file out again
            with open('input_aimd/pyASE.py', 'w', newline='\n') as filejob:
                filejob.write(filedata)

        self.remote.put_files(path=self.workdir_text.value, path_input='input_aimd/', host=self.host, kwargs=self.kwargs)
        print('files moved\n')
    ...
    def rundft_action(self, atoms, password, passphrase):
